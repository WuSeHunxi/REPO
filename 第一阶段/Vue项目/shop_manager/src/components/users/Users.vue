<template>
  <div>
    ...
    <el-card>
      <el-row :gutter="20">
        <el-col :span="7">
          <el-input placeholder="请输入内容" clearable @click="getUserList" v-model="queryInfo.query">
        ...
        <el-table-column label="操作">
          <template v-slot="scope">
            ...
            <el-button
              ...
              icon="el-icon-delete"
            ></el-button>
            <el-button type="dark" size="mini" @click="setRole(scope.row)" icon="el-icon-edit"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
